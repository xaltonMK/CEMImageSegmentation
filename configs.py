class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('image_target_size', (128, 128, 3), 'the target size to resize the image')
        ...
        self.define('cnn_downscaling_factor', 0,
                    'Controls the cnn layers responsible for downscaling the input image. if input image is 512x512 and downscaling factor is set to 2 then the downscaling cnn will output image with size ğğx128. Note it is a learnable net and if set to 0 it will skip it')
